  ...
  return (
    <section className="container mx-auto p-6 relative">
      ...
      <article className="bg-off-white rounded-3xl flex flex-col justify-center items-center p-12 min-h-[12rem]">
        <div className="text-pink tracking-widest leading-10 font-semibold uppercase">
        ...
        <div className="flex flex-col md:flex-row mt-4 gap-4 items-center">
          <input
            type="text"
            placeholder="Email"
            className="min-w-[20rem] max-w-[90%] h-14 py-1 text-sm font-semibold text-opaque-black rounded-lg outline-none px-4 border-yellow-50 border-2"
          />
          <Button
            classes={[
              "bg-schbang-blue",
