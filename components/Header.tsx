        ...
        <>
            <header className='flex justify-between py-4 px-4 lg:px-8'>
                <section className='flex gap-4 items-center'>
                    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="h-5 w-5 stroke-current md:h-6 md:w-6 inline-block lg:hidden"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
                    <Photo bucketUrl='logo' width={24} height={24} isPrority alt='logo' />
                    <h3 className='font-extrabold'>Travlog</h3>
                </section>
                <nav className='lgap-4 hidden lg:flex'>
                    {links.map(link => (
